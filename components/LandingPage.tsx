...
const LandingPage: React.FC<LandingPageProps> = ({ event, onRSVP, onAdminClick }) => {
  return (
    <div className="min-h-screen floral-pattern bg-[#fdfcfb] transition-colors duration-1000">
      <div className="max-w-md mx-auto px-6 py-16 animate-in fade-in slide-in-from-bottom-8 duration-[1500ms] delay-700 flex flex-col items-center fill-mode-both">
        ...
        <section className="w-full space-y-12 mb-20 bg-white/60 backdrop-blur-md p-8 rounded-3xl border border-white/50 shadow-sm ring-1 ring-black/[0.02]">
