  ...
  return (
    <div className="bg-white p-6 md:p-10 rounded-3xl shadow-[0_4px_30px_rgba(0,0,0,0.03)] border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        <div>
          <label className="text-[10px] tracking-[0.2em] uppercase text-gray-400 mb-3 block font-semibold">Full Name</label>
          <input 
            required
            type="text"
        ...
        <div className="pt-4">
          <button 
            ...
            type="submit"
            className="w-full bg-[#1a1a1a] text-white h-[60px] text-[11px] tracking-[0.5em] uppercase hover:bg-[#333] transition-all disabled:bg-gray-200 rounded-2xl relative overflow-hidden group tap-active"
          >
